...
type SpecNumUtil[R any, T int | int8 | int16 | int32 | int64 | float32 | float64 | byte] struct {
	specNums     splitutil.Segments[T]
	SyncMode     bool
	ExcludeEmpty bool
}

type SplitDumpTask[R any, T int | int8 | int16 | int32 | int64 | float32 | float64 | byte] struct {
	Util[R]
	splitutil.Segment[T]
}
